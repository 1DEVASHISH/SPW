...
#Labels
Label(master, text = "Welcome to the Madhav Bank", font=('calibri',14)).grid(row=0,sticky=N,pady=10)
Label(master, text = "Where the world comes for Financial Advice", font=('calibri',10)).grid(row=1,sticky=N)
